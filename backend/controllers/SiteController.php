...
class SiteController extends Controller
{
    ...
    public function behaviors()
    {
        return [
            'access' => [
                ...
                'rules' => [
                    [
                        'actions' => ['login', 'error', 'popup', 'blocked', 'thanks-page'],
                        'allow' => true,
                    ],
                    [
                        'actions' => ['logout', 'index', 'popup', 'blocked', 'thanks-page'],
                        'allow' => true,
                        'roles' => ['@'],
                    ],
                ],
    ...
    public function ThanksLayout()
    {

        $thanks = Yii::$app->params['thanks'];

        if ($thanks) {
            $this->layout = 'thanks-page';
        } else {
            $this->layout = 'main';
        }
    }

    public function actionThanksPage()
    {
        
        $this->ThanksLayout();
        return $this->render('thanks-page');
    }
    ...
    public function actionLogin()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->login()) {
            ...
            if (Yii::$app->request->isPost) {
                Yii::$app->session->setFlash('auth', 'Username atau password salah.');
            }
